...
// This script is not part of temit, but rather a tool to rewrite some parts
...
async function main() {
  await new Promise((resolve, reject) =>
    exec(
      "api-extractor run --local --verbose && api-documenter markdown --input-folder temp --output-folder website/docs/api",
      (err, stdout, stderr) => {
        console.log(stdout);
